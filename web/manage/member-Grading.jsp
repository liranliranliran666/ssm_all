...
<meta http-equiv="Cache-Control" content="no-siteapp" />
 <link href="/manage/assets/css/bootstrap.min.css" rel="stylesheet" />
        ...
        <link rel="stylesheet" href="/manage/font/css/font-awesome.min.css" />
        <!--[if lte IE 8]>
        ...
        <script src="/manage/assets/dist/echarts.js"></script>
     ...
     <div class="side_list">
      ...
      <div class="widget-body">
         <ul class="b_P_Sort_list">
             <li><i class="orange  fa fa-user-secret"></i><a href="javascript:void(0)">全部(235)</a></li>
             <li><i class="fa fa-diamond pink "></i> <a href="javascript:void(0)">普通会员(235)</a></li>
             <li> <i class="fa fa-diamond pink "></i> <a href="javascript:void(0)">铁牌会员(2215)</a> </li>
             <li> <i class="fa fa-diamond pink "></i> <a href="javascript:void(0)">铜牌会员(3456)</a></li>
             <li><i class="fa fa-diamond pink "></i> <a href="javascript:void(0)">银牌会员(4332)</a></li>
             <li><i class="fa fa-diamond pink "></i> <a href="javascript:void(0)">金牌会员(1332)</a></li>
             <li> <i class="fa fa-diamond grey"></i> <a href="javascript:void(0)">钻石会员(4543)</a></li>
             <li> <i class="fa fa-diamond red"></i> <a href="javascript:void(0)">红钻会员(343)</a></li>
             <li> <i class="fa fa-diamond blue"></i> <a href="javascript:void(0)">蓝钻会员(2343)</a></li>
             <li> <i class="fa fa-diamond grey"></i> <a href="javascript:void(0)">黑钻2(53)</a></li>
            </ul>
  </div>
  </div>
  </div>  
           ...
           <c:forEach items="${users}" var="user">
               <tr>
                   ...
                   <td class="td-manage">
                       ...
                       <a title="删除" href="javascript:;"  onclick="member_del(this,${user.id})" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
                   </td>
               </tr>
           </c:forEach>
           </tbody>
