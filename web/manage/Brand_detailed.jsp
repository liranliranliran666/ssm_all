...
<meta http-equiv="Cache-Control" content="no-siteapp" />
  ...
  <link href="/manage/Widget/icheck/icheck.css" rel="stylesheet" type="text/css" />
  <!--[if IE 7]>
  ...
  <![endif]-->
  <script src="/manage/js/jquery-1.9.1.min.js"></script>
  ...
  <script src="/manage/js/lrtk.js" type="text/javascript"></script>
<title>品牌详细</title>
</head>
...
<div class="page-content clearfix">
 ...
 <div class="border clearfix">
       <span class="l_f">
        <a href="product-add.html"  title="添加商品" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加商品</a>
         ...
         <div class="side_list">
          ...
          <div class="widget-body">
            <ul class="b_P_Sort_list">
             <li><i class="orange icon-folder-close"></i></i><a href="javascript:void(0)">全部(235)</a></li>
             <li><i class="icon-file-text grey"></i> <a href="javascript:void(0)">乳液面霜(5)</a></li>
             <li> <i class="icon-file-text grey"></i><a href="javascript:void(0)">套装(15)</a> </li>
             <li> <i class="icon-file-text grey"></i><a href="javascript:void(0)">洁面(6)</a></li>
             <li><i class="icon-file-text grey"></i> <a href="javascript:void(0)">精华(2)</a></li>
             <li><i class="icon-file-text grey"></i> <a href="javascript:void(0)">爽肤水(12)</a></li>
             <li> <i class="icon-file-text grey"></i><a href="javascript:void(0)">防晒(6)</a></li>
             <li> <i class="icon-file-text grey"></i><a href="javascript:void(0)">面膜(7)</a></li>
             <li> <i class="icon-file-text grey"></i><a href="javascript:void(0)">眼霜(23)</a></li>
             <li> <i class="icon-file-text grey"></i><a href="javascript:void(0)">精华露(53)</a></li>
             <li> <i class="icon-file-text grey"></i><a href="javascript:void(0)">爽肤水(25)</a></li>
             <li> <i class="icon-file-text grey"></i><a href="javascript:void(0)">隔离(52)</a></li>
             <li><i class="icon-file-text grey"></i> <a href="javascript:void(0)">眼部护理(45)</a></li>
            </ul>
