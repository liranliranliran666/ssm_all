...
<html lang="en">
	<head>
		...
		<!-- <![endif]-->
		<!--[if IE]>
         <script type="text/javascript">window.jQuery || document.write("<script src='/manage/assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");</script>
        <![endif]-->
...
<script type="text/javascript">
					...
					<ul class="nav nav-list" id="nav_list">
				     <li class="home" onclick="tohome()"><a href="javascript:void(0)" name="home.html" class="iframeurl" title=""><i class="icon-dashboard"></i><span class="menu-text"> 系统首页 </span></a></li>
                  ...
                  <li>
                    ...
                    <ul class="submenu">
                    <li class="home" onclick="tolist()"><a href="javascript:void(0)" name="user_list.jsp" title="会员列表"  class="iframeurl"><i class="icon-double-angle-right" href="${pageContext.request.contextPath}/user/list" ></i>会员列表</a></li>
                    <li class="home" onclick="tomember()"><a href="javascript:void(0)" name="member-Grading.html" title="等级管理"  class="iframeurl"><i class="icon-double-angle-right"></i>等级管理</a></li>
                    <li class="home" onclick="integration()"><a href="javascript:void(0)" name="integration.html" title="会员记录管理"  class="iframeurl"><i class="icon-double-angle-right"></i>会员记录管理</a></li>
...
<!-- /.page-content -->
         ...
         <div class="footer_style" id="footerstyle">  
          <p class="l_f">版权所有：传智播客</p>
          <p class="r_f">地址：江苏沭阳　电话：400-618-4000</p>
         </div>
         <!--修改密码样式-->
...
<script>
	...
	function tohome() {
		document.getElementById("iframe").src="/user/tohome"
	}
	function tomember(){
		document.getElementById("iframe").src="/user/member"
	}
	function tointegration(){
		document.getElementById("iframe").src="/user/integration"
	}
</script>
