...
<meta http-equiv="Cache-Control" content="no-siteapp" />
 <link href="/manage/assets/css/bootstrap.min.css" rel="stylesheet" />
        ...
        <script type="text/javascript" src="/manage/Widget/swfupload/swfupload.js"></script>
        <script type="text/javascript" src="/manage/Widget/swfupload/swfupload.queue.js"></script>
        <script type="text/javascript" src="/manage/Widget/swfupload/swfupload.speed.js"></script>
        <script type="text/javascript" src="/manage/Widget/swfupload/handlers.js"></script>
<title>广告管理</title>
</head>
     ...
     <div class="side_list">
      ...
      <div class="widget-body">
         <ul class="b_P_Sort_list">
             ...
             <li><i class="fa fa-image pink "></i> <a href="javascript:void(0)">首页轮播广告大(5)</a></li>
             <li> <i class="fa fa-image pink "></i> <a href="javascript:void(0)">轮播广告小1(3)</a> </li>
             <li> <i class="fa fa-image pink "></i> <a href="javascript:void(0)">轮播广告小2(3)</a></li>
             <li><i class="fa fa-image pink "></i> <a href="javascript:void(0)">单个广告(6)</a></li>
         </ul>
  </div>
  </div>
  </div>  
