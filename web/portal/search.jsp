...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
	<head>
		...
		<link href="/portal/css/seastyle.css" rel="stylesheet" type="text/css" />
							...
							<ul class="select">
									...
									<dl id="select1">
										<dt class="am-badge am-round">品牌</dt>	
										 ...
										 <div class="dd-conent">										
											...
											<dd><a href="javascript:void(0)">百草味</a></dd>
											<dd><a href="javascript:void(0)">良品铺子</a></dd>
											<dd><a href="javascript:void(0)">新农哥</a></dd>
											<dd><a href="javascript:void(0)">楼兰蜜语</a></dd>
											<dd><a href="javascript:void(0)">口水娃</a></dd>
											<dd><a href="javascript:void(0)">考拉兄弟</a></dd>
										 </div>
								...
								<li class="select-list">
									<dl id="select2">
										...
										<div class="dd-conent">
											<dd class="select-all selected"><a href="javascript:void(0)">全部</a></dd>
											<dd><a href="javascript:void(0)">东北松子</a></dd>
											<dd><a href="javascript:void(0)">巴西松子</a></dd>
											<dd><a href="javascript:void(0)">夏威夷果</a></dd>
											<dd><a href="javascript:void(0)">松子</a></dd>
										</div>
									</dl>
								</li>
								<li class="select-list">
									<dl id="select3">
										...
										<div class="dd-conent">
											<dd class="select-all selected"><a href="javascript:void(0)">全部</a></dd>
											<dd><a href="javascript:void(0)">手剥松子</a></dd>
											<dd><a href="javascript:void(0)">薄壳松子</a></dd>
											<dd><a href="javascript:void(0)">进口零食</a></dd>
											<dd><a href="javascript:void(0)">有机零食</a></dd>
										</div>
									</dl>
								</li>
