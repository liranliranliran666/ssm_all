...
<head>
    ...
    <link href="/portal/css/hmstyle.css" rel="stylesheet" type="text/css"/>
    <!--后面的自己改 其他也页面也自己改 看懂没？？1-->
    <link href="/portal/css/skin.css" rel="stylesheet" type="text/css" />
    ...
    <div class="am-container header">
        <ul class="message-l">
            <div class="topMessage">
                <div class="menu-hd">
                    <a href="${pageContext.request.contextPath}/user/tologin" target="_top" class="h">亲，请登录</a>
                    <a href="${pageContext.request.contextPath}/user/toregister" target="_top">免费注册</a>
                </div>
            </div>
        </ul>
        <ul class="message-r">
            <div class="topMessage home">
                <div class="menu-hd"><a href="${pageContext.request.contextPath}/user/toregister" target="_top" class="h">商城首页</a></div>
            </div>
            <div class="topMessage my-shangcheng">
                <div class="menu-hd MyShangcheng"><a href="${pageContext.request.contextPath}/user/tologin" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div>
            </div>
            <div class="topMessage mini-cart">
                <div class="menu-hd"><a id="mc-menu-hd" href="${pageContext.request.contextPath}/user/tologin" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">0</strong></a></div>
            </div>
            <div class="topMessage favorite">
                <div class="menu-hd"><a href="${pageContext.request.contextPath}/user/tologin" target="_top"><i class="am-icon-heart am-icon-fw"></i><span>收藏夹</span></a></div>
            </div>
        </ul>
    </div>
...
<div class="banner">
    ...
    <div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
        <ul class="am-slides">
            <li class="banner1"><a href="introduction.jsp"><img src="/portal/images/ad1.jpg" /></a></li>
            <li class="banner2"><a><img src="/portal/images/ad2.jpg" /></a></li>
            <li class="banner3"><a><img src="/portal/images/ad3.jpg" /></a></li>
            <li class="banner4"><a><img src="/portal/images/ad4.jpg" /></a></li>
...
<div class="shopNav">
    <div class="slideall">
        ...
        <div class="nav-cont">
            <ul>
                <li class="index"><a href="${pageContext.request.contextPath}/user/toindex">首页</a></li>
                        ...
                        <ul class="category-list" id="js_climit_li">
                            <li class="appliance js_toggle relative first">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="/portal/images/cake.png"></i><a class="ml-22" title="点心">点心/蛋糕</a></h3>
                                    <em>&gt;</em></div>
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="/portal/images/cookies.png"></i><a class="ml-22" title="饼干、膨化">饼干/膨化</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="/portal/images/meat.png"></i><a class="ml-22" title="熟食、肉类">熟食/肉类</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="/portal/images/bamboo.png"></i><a class="ml-22" title="素食、卤味">素食/卤味</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="/portal/images/nut.png"></i><a class="ml-22" title="坚果、炒货">坚果/炒货</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="/portal/images/candy.png"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="/portal/images/chocolate.png"></i><a class="ml-22" title="巧克力">巧克力</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="/portal/images/fish.png"></i><a class="ml-22" title="海味、河鲜">海味/河鲜</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="/portal/images/tea.png"></i><a class="ml-22" title="花茶、果茶">花茶/果茶</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li class="appliance js_toggle relative last">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="/portal/images/package.png"></i><a class="ml-22" title="品牌、礼包">品牌/礼包</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
        ...
        <div class="am-g am-g-fixed smallnav">
            <div class="am-u-sm-3">
                <a href="sort.jsp"><img src="/portal/images/navsmall.jpg" />
                    <div class="title">商品分类</div>
                </a>
            </div>
            <div class="am-u-sm-3">
                <a href="javascript:void(0)"><img src="/portal/images/huismall.jpg" />
                    <div class="title">大聚惠</div>
                </a>
            </div>
            <div class="am-u-sm-3">
                <a href="javascript:void(0)"><img src="/portal/images/mansmall.jpg" />
                    <div class="title">个人中心</div>
                </a>
            </div>
            <div class="am-u-sm-3">
                <a href="javascript:void(0)"><img src="/portal/images/moneysmall.jpg" />
        ...
        <div class="marqueen">
            ...
            <div class="demo">
                ...
                <ul>
                    <li class="title-first"><a target="_blank" href="blog.jsp">
                        <img src="/portal/images/TJ2.jpg"></img>
                        <span>[特惠]</span>商城爆品1分秒
                    </a></li>
                    <li class="title-first"><a target="_blank" href="blog.jsp">
                        <span>[公告]</span>商城与广州市签署战略合作协议
                        <img src="/portal/images/TJ.jpg"></img>
                        <p>XXXXXXXXXXXXXXXXXX</p>
                    </a></li>

                    <div class="mod-vip">
                        <div class="m-baseinfo">
                            <a href="${pageContext.request.contextPath}/user/toindex.html">
                                <img src="/portal/images/getAvatar.do.jpg">
                            </a>
                            <em>
                                Hi,<span class="s-name">请先登录!</span>
                                <a href="javascript:void(0)"><p>点击更多优惠活动</p></a>
                            </em>
                        </div>
                        <div class="member-logout">
                            <a class="am-btn-warning btn" href="${pageContext.request.contextPath}/user/tologin">登录</a>
                            <a class="am-btn-warning btn" href="${pageContext.request.contextPath}/user/toregister">注册</a>
                        </div>
                    ...
                    <li><a target="_blank" href="blog.jsp"><span>[特惠]</span>洋河年末大促，低至两件五折</a></li>
                    <li><a target="_blank" href="blog.jsp"><span>[公告]</span>华北、华中部分地区配送延迟</a></li>
                    <li><a target="_blank" href="blog.jsp"><span>[特惠]</span>家电狂欢千亿礼券 买1送1！</a></li>

                </ul>
                <div class="advTip"><img src="/portal/images/advTip.jpg"/></div>
            </div>
        </div>
        <div class="clear"></div>
    </div>
    ...
    <div class="shopMain" id="shopmain">
        ...
        <div class="am-g am-g-fixed recommendation">
            <div class="clock am-u-sm-3">
                <img src="/portal/images/2016.png "></img>
                <p>今日<br>推荐</p>
            </div>
            <div class="am-u-sm-4 am-u-lg-3 ">
                ...
                <div class="recommendationMain one">
                    <a href="introduction.jsp"><img src="/portal/images/tj.png "></img></a>
                </div>
            </div>
            <div class="am-u-sm-4 am-u-lg-3 ">
                <div class="info ">
                ...
                <div class="recommendationMain two">
                    <img src="/portal/images/tj1.png "></img>
                </div>
            </div>
            <div class="am-u-sm-4 am-u-lg-3 ">
                <div class="info ">
                ...
                <div class="recommendationMain three">
                    <img src="/portal/images/tj2.png "></img>
                </div>
            </div>
            ...
            <div class="am-g am-g-fixed ">
                <div class="am-u-sm-3 ">
                    ...
                    <div class="activityMain ">
                        <img src="/portal/images/activity1.jpg "></img>
                    </div>
                    <div class="info ">
                        <h3>春节送礼优选</h3>
                    </div>
                ...
                <div class="am-u-sm-3 ">
                    ...
                    <h4>特惠</h4>
                    <div class="activityMain ">
                        <img src="/portal/images/activity2.jpg "></img>
                    </div>
                    <div class="info ">
                        <h3>春节送礼优选</h3>
                    </div>
                ...
                <div class="am-u-sm-3 ">
                    ...
                    <h4>团购</h4>
                    <div class="activityMain ">
                        <img src="/portal/images/activity3.jpg "></img>
                    </div>
                    <div class="info ">
                        <h3>春节送礼优选</h3>
                    </div>
                ...
                <div class="am-u-sm-3 last ">
                    ...
                    <h4>超值</h4>
                    <div class="activityMain ">
                        <img src="/portal/images/activity.jpg "></img>
                    </div>
                    <div class="info ">
                        <h3>春节送礼优选</h3>
                    </div>
            ...
            <div class="am-g am-g-fixed floodFour">
                <div class="am-u-sm-5 am-u-md-4 text-one list ">
                    ...
                    <a href="javascript:void(0)">
                        ...
                        <img src="/portal/images/act1.png " />
                    </a>
                ...
                <div class="am-u-sm-7 am-u-md-4 text-two sug">
                    ...
                    <a href="javascript:void(0)"><img src="/portal/images/2.jpg" /></a>
                </div>
                ...
                <div class="am-u-sm-7 am-u-md-4 text-two">
                    ...
                    <a href="javascript:void(0)"><img src="/portal/images/1.jpg" /></a>
                </div>
                ...
                <div class="am-u-sm-3 am-u-md-2 text-three sug">
                    ...
                    <a href="javascript:void(0)"><img src="/portal/images/3.jpg" /></a>
                </div>
                ...
                <div class="am-u-sm-3 am-u-md-2 text-three ">
                    ...
                    <a href="javascript:void(0)"><img src="/portal/images/4.jpg" /></a>
                </div>
                ...
                <div class="am-u-sm-3 am-u-md-2 text-three last big ">
                    ...
                    <a href="javascript:void(0)"><img src="/portal/images/5.jpg" /></a>
                </div>
        ...
        <div class="footer ">
            ...
            <div class="footer-bd ">
                <p>
                    <a href="http://www.huafei.com">关于华飞</a>
    ...
    <div id="sidebar">
        <div id="wrap">
            <div id="prof" class="item ">
                ...
                <div class="ibar_login_box status_login ">
                    <div class="avatar_box ">
                        <p class="avatar_imgbox "><img src="/portal/images/no-img_mid_.jpg " /></p>
                        <ul class="user_info ">
                            <li>请先登录！</li>
                        </ul>
                    </div>
            ...
            <div id="brand " class="item ">
                <a href="javascript:void(0)">
                    <span class="wdsc "><img src="/portal/images/wdsc.png " /></span>
                </a>
                <div class="mp_tooltip ">
                    我的收藏
                    <i class="icon_arrow_right_black "></i>
            ...
            <div id="broadcast " class="item ">
                <a href="javascript:void(0)">
                    <span class="chongzhi "><img src="/portal/images/chongzhi.png " /></span>
                </a>
                <div class="mp_tooltip ">
                    我要充值
                    <i class="icon_arrow_right_black "></i>
            ...
            <div class="quick_toggle ">
                <li class="qtitem ">
                    <a href="foot.jsp"><span class="kfzx "></span></a>
                    <div class="mp_tooltip ">客服中心<i class="icon_arrow_right_black "></i></div>
                </li>
                <!--二维码 -->
                <li class="qtitem ">
                    <a href="javascript:void(0)"><span class="mpbtn_qrcode "></span></a>
                    <div class="mp_qrcode " style="display:none; "><img src="/portal/images/weixin_code_145.png " /><i class="icon_arrow_white "></i></div>
                </li>
                <li class="qtitem ">
...
<script>
    window.jQuery || document.write('<script src="/portal/basic/js/jquery.min.js "><\/script>');
</script>
<script type="text/javascript " src="/portal/basic/js/quick_links.js "></script>
</body>
