...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
	<head>
		...
		<link href="/portal/css/cartstyle.css" rel="stylesheet" type="text/css" />

		<link href="/portal/css/jsstyle.css" rel="stylesheet" type="text/css" />

		<script type="/portal/text/javascript" src="js/address.js"></script>
				...
				<div class="paycont">
                   ...
                   <span class="buy-user">艾迪 </span>
					...
					<div class="logistics">
						<h3>选择支付方式</h3>
						<ul class="pay-list">
							<li class="pay card"><img src="/portal/images/wangyin.jpg" />银联<span></span></li>
							<li class="pay qq"><img src="/portal/images/weizhifu.jpg" />微信<span></span></li>
							<li class="pay taobao"><img src="/portal/images/zhifubao.jpg" />支付宝<span></span></li>
						</ul>
					</div>
					<div class="clear"></div>
												...
												<li class="td td-item">
													<div class="item-pic">
														<a href="#" class="J_MakePoint">
															<img src="/portal/images/kouhong.jpg_80x80.jpg" class="itempic J_ItemImg"></a>
													</div>
													<div class="item-info">
								   ...
								   <span class="province">湖北</span>省
									...
									<div id="holyshit269" class="submitOrder">
										<div class="go-btn-wrap">
											<a id="J_Go" href="${pageContext.request.contextPath}/user/tosuccess" class="btn-go" tabindex="0" title="点击此按钮，提交订单">提交订单</a>
										</div>
									</div>
									<div class="clear"></div>
								</div>
