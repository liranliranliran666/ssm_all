...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
	<head>
		...
		<link href="/portal/css/orstyle.css" rel="stylesheet" type="text/css">
									...
									<div class="order-main">
										<div class="order-list">
													...
													<div class="order-left">
														...
														<ul class="item-list">
															<li class="td td-item">
																<div class="item-pic">
																	<a href="#" class="J_MakePoint">
																		<img src="/portal/images/62988.jpg_80x80.jpg" class="itempic J_ItemImg">
																	</a>
																</div>
																<div class="item-info">
																	<div class="item-basic-info">
												...
												<div class="order-content">
													<div class="order-left">
														<ul class="item-list">
															...
															<li class="td td-operation">
																<div class="item-operation">
																	<a href="${pageContext.request.contextPath}/user/torefund">退款</a>
																</div>
															</li>
														</ul>
											...
											<div class="order-status3">
												<div class="order-title">
													<div class="dd-num">订单编号：<a href="javascript:void (0);">1601430</a></div>
													<span>成交时间：2015-12-20</span>
													<!--    <em>店铺：小桔灯</em>-->
												</div>
												<div class="order-content">
													<div class="order-left">
														<ul class="item-list">
															...
															<li class="td td-operation">
																<div class="item-operation">
																	<a href="${pageContext.request.contextPath}/user/torefund">退款/退货</a>
																</div>
															</li>
														</ul>
														...
														<div class="move-right">
															<li class="td td-status">
																<div class="item-status">
																	...
																	<p class="order-info"><a href="javascript:void(0)">取消订单</a></p>
												...
												<div class="order-content">
													...
													<div class="order-right">
														...
														<div class="move-right">
															...
															<li class="td td-change">
																<a href="${pageContext.request.contextPath}/user/tocommentlist">
																	<div class="am-btn am-btn-danger anniu">
																		评价商品</div>
																</a>
															</li>
