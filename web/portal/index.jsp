							...
							<ul>
								...
								<div class="mod-vip">
									...
									<div class="member-logout">
										<a class="am-btn-warning btn" href="${pageContext.request.contextPath}/user/portalUser">个人中心</a>
										<a class="am-btn-warning btn" href="${pageContext.request.contextPath}/user/toexit">退出</a>
									</div>
				...
				<div id="sidebar">
					<div id="wrap">
						<div id="prof" class="item ">
							...
							<div class="ibar_login_box status_login ">
								...
								<div class="login_btnbox ">
									<a href="${pageContext.request.contextPath}/user/toorderinfo" class="login_order ">我的订单</a>
									<a href="${pageContext.request.contextPath}/user/tocollection " class="login_favorite ">我的收藏</a>
								</div>
						...
						<div id="shopCart " class="item ">
							<a href="${pageContext.request.contextPath}/user/toshopcart">
						...
						<div id="asset " class="item ">
							<a href="${pageContext.request.contextPath}/user/tocoupon">
						...
						<div id="foot " class="item ">
							<a href="${pageContext.request.contextPath}/user/tofoot">
