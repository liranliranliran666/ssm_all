...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
	<head>
		...
		<link href="/portal/css/bostyle.css" rel="stylesheet" type="text/css">
									...
									<div class="cart-table-th">
										...
										<div class="order-main">
											...
											<ul class="item-list">
												<li class="td td-from">
													<div class="item-img">
														<img src="/portal/images/566fda5cN4b8a1675.gif">
													</div>
												...
												<li class="td td-usestatus ">
													<div class="item-usestatus ">
														<p>可使用</p><span><img src="/portal/images/gift_stamp_1.png"/></span>
													</div>
												</li>
											</ul>
									...
									<div class="cart-table-th">
										...
										<div class="order-main">
											...
											<ul class="item-list">
												...
												<li class="td td-usestatus ">
													<div class="item-usestatus ">
														<p>已用完</p><span><img src="/portal/images/gift_stamp_2.png"/></span>
													</div>
												</li>
											</ul>
...
<!--已过期-->
											<ul class="item-list">
												...
												<li class="td td-usestatus ">
													<div class="item-usestatus ">
														<p>已过期</p><span><img src="/portal/images/gift_stamp_3.png"/></span>
													</div>
												</li>
											</ul>
