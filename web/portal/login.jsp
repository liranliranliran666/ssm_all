...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
	<head lang="en">
		...
		<link rel="stylesheet" href="/portal/AmazeUI-2.4.2/assets/css/amazeui.css" />
	...
	<body>
		...
		<div class="login-boxtitle">
			<a href="home.jsp"><img alt="logo" src="/portal/images/logobig.png" /></a>
		</div>
		...
		<div class="login-banner">
            ...
            <div class="login-links">
                <label for="remember-me"><input id="remember-me" type="checkbox">记住密码</label>
								...
								<a href="${pageContext.request.contextPath}/user/toregister" class="zcnext am-fr am-btn-default">注册</a>
								<br />
            </div>
					<div>${error}</div>
								<div class="am-cf">
