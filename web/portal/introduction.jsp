...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
	<head>
		...
		<link type="/portal/text/css" href="css/optstyle.css" rel="stylesheet" />
		<link type="/portal/text/css" href="css/style.css" rel="stylesheet" />
		...
		<script type="text/javascript" src="/portal/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
		<script type="text/javascript" src="/portal/js/jquery.imagezoom.min.js"></script>
		<script type="text/javascript" src="/portal/js/jquery.flexslider.js"></script>
		<script type="text/javascript" src="/portal/js/list.js"></script>
							...
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="javascript:void(0)"><img src="images/01_small.jpg" mid="images/01_mid.jpg" big="images/01.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="javascript:void(0)"><img src="images/02_small.jpg" mid="images/02_mid.jpg" big="images/02.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="javascript:void(0)"><img src="images/03_small.jpg" mid="images/03_mid.jpg" big="images/03.jpg"></a>
									</div>
								</li>
							</ul>
						</div>
